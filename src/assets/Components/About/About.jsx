  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        <h3>ABOUT UMNIVERSITY</h3>
        <h2>Nurturing Tomorrow's Leaders Today</h2>
        <p>Embark on a transformative educational journey with our
            university's comprehensive educational programs. Our cutting-edge curriculum is designed to empower students with the knowledge,
        ...
        <p>
            ...
            programs ofers the perfect pathway to achieve your goals
            and unlock your full potentials in shapping the future of your education.
        </p>
      </div>
    </div>
  )
